                            ...
                            <div className="sherah-dsinner">
                                ...
                                <div className="sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                    <div className="sherah-table__head sherah-table__main ">
                                        <h4 className="sherah-order-title">Items from Order #21</h4>
                                        <div>
                                            OrderType:
                                        ...
                                        <div className="sherah-order-right">
                                            <p className="sherah-order-text">
                                                Jan 27, 2024 12:09 PM / Total $51.5
                                            </p>
                                                    ...
                                                    <tbody className="sherah-table__body">
                                                        <tr>
                                                            ...
                                                            <td className="sherah-table__column-2 sherah-table__data-2">
                                                                <div className="sherah-table__product-name">
                                                                    ...
                                                                    <p className="sherah-table__product-name--text">
                                                                        <span>Size :</span>(<strong>Small</strong>)
                                                                    </p>
                                                                    <p className="sherah-table__product-name--text"></p>
                                                                </div>
                                                            </td>
                                                            <td></td>
                                                            ...
                                                            <td className="sherah-table__column-4 sherah-table__data-4">
                                                                <div className="sherah-table__product-content">
                                                                    <p className="sherah-table__product-desc">$30</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                ...
                                                <div className="order-totals">
                                                    <ul className="order-totals__list">
                                                        <li className="order-totals__list--sub">
                                                            <span>Subtotal</span>
                                                            <span className="order-totals__amount">$30</span>
                                                        </li>
                                                        <li>
                                                            <span>Discount</span>
                                                        ...
                                                        <li>
                                                            <span>Shipping</span>
                                                            <span className="order-totals__amount">$20</span>
                                                        </li>
                                                        <li>
                                                            <span>Vat Tax</span>
                                                            <span className="order-totals__amount">$1.5</span>
                                                        </li>
                                                        <li className="order-totals__bottom">
                                                            <span>Total</span>
                                                            <span className="order-totals__amount">$51.5</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <div className="row">
                                        ...
                                        <div className="sherah-contact-card sherah-default-bg sherah-border mg-top-30">
                                            ...
                                            <div className="sherah-vcard__body">
                                                ...
                                                <div className="sherah-vcard__content">
                                                    <h4 className="sherah-vcard__title">John Doe</h4>
                                    ...
                                    <div className="col-lg-6 col-md-6 col-12">
                                        <div className="sherah-contact-card sherah-default-bg  sherah-border mg-top-30">
                                            ...
                                            <div className="sherah-vcard__body">
                                                <div className="sherah-vcard__content">
                                                    <h4 className="sherah-vcard__title">David Warner</h4>
                                                    <ul className="sherah-vcard__contact">
                                                        <li>
                                                            <a href="tel:123-343-4444">
                                                                <svg
                                ...
                                <hr />
                                <form
                                    action="https://reservq.minionionbd.com/order/change/21"
                                    method="POST"
                                >
                                    <input
                                        type="hidden"

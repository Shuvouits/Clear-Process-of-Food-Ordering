...
function AddProduct() {
    ...
    const handleMultiselectChange = (selectedList, selectedItem) => {
        // Update form data with selected options
        setSelectedOptions(selectedList);

        // Extract IDs of selected options
        const selectedOptionIds = selectedList.map(option => option.id);

        // Update formData
        setFormData({ ...formData, optionalItem: selectedOptionIds });
    };  
                                                            ...
                                                            <div className="col-12">
                                                                <div className="form-group">
                                                                    ...
                                                                    <div className="checkbox-group">
                                                                        ...
                                                                        <Multiselect id='optionalItem' onSelect={handleMultiselectChange} options={record} displayValue='name' />

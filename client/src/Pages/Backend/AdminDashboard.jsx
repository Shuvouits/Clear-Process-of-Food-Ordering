                                    ...
                                    <div className="col-lg-3 col-md-6 col-12">
                                        ...
                                        <div className="sherah-progress-card sherah-border sherah-default-bg mg-top-30">
                                            <div className="sherah-progress-card__icon sherah-default-bg sherah-border">
                                                ...
                                                >
                                                    <path
                                                        d="M20.7207 5.5H19.5625C19.2641 5.5 18.978 5.61853 18.767 5.82951C18.556 6.04048 18.4375 6.32663 18.4375 6.625C18.4375 6.92337 18.556 7.20952 18.767 7.42049C18.978 7.63147 19.2641 7.75 19.5625 7.75H19.5957C19.8941 7.75 20.1802 7.86853 20.3912 8.07951C20.6022 8.29048 20.7207 8.57663 20.7207 8.875C20.7207 9.17337 20.6022 9.45952 20.3912 9.67049C20.1802 9.88147 19.8941 10 19.5957 10H18.4375"
                                                        stroke="#F01543"
                                                        strokeWidth="1.3"
                                                        strokeLinecap="round"
                                                    ...
                                                    />
                                                    <path
                                                        d="M10.5625 13.375H7.75V1.5625H31.375V7.75"
                                                        stroke="#F01543"
                                                        strokeWidth="1.3"
                                                        strokeLinecap="round"
                                                        strokeLinejoin="round"
                                                    />
                                                    <path
                                                        d="M11.125 3.8125C11.125 4.11087 11.0065 4.39702 10.7955 4.608C10.5845 4.81897 10.2984 4.9375 10 4.9375"
                                                        stroke="#F01543"
                                                        strokeWidth="1.3"
                                                        strokeLinecap="round"
                                                        strokeLinejoin="round"
                                                    />
                                                    <path
                                                        d="M28 3.8125C28 4.11087 28.1185 4.39702 28.3295 4.608C28.5405 4.81897 28.8266 4.9375 29.125 4.9375"
                                                        stroke="#F01543"
                                                        strokeWidth="1.3"
                                                        strokeLinecap="round"
                                                        strokeLinejoin="round"
                                                    />
                                                    <path
                                                        d="M10 10C10.2984 10 10.5845 10.1185 10.7955 10.3295C11.0065 10.5405 11.125 10.8266 11.125 11.125"
                                                        stroke="#F01543"
                                                        strokeWidth="1.3"
                                                        strokeLinecap="round"
                                                        strokeLinejoin="round"
                                                    ...
                                                    />
                                                    <path
                                                        d="M19.5625 25.1875V24.625C19.5625 22.984 18.9106 21.4102 17.7502 20.2498C16.5898 19.0894 15.016 18.4375 13.375 18.4375C11.734 18.4375 10.1602 19.0894 8.99978 20.2498C7.8394 21.4102 7.1875 22.984 7.1875 24.625V25.1875"
                                                        stroke="#F01543"
                                                        strokeWidth="1.3"
                                                        strokeLinecap="round"
                                                        strokeLinejoin="round"
                                                    ...
                                                    />
                                                    <path
                                                        d="M31.3754 19L29.4803 17.3125H17.7066C17.1421 17.3125 16.5982 17.1003 16.1828 16.7179L13.3703 14.1304C13.1881 13.9483 13.0448 13.7308 12.9494 13.4915C12.8539 13.2521 12.8082 12.9958 12.8151 12.7382C12.822 12.4805 12.8813 12.227 12.9895 11.9931C13.0976 11.7592 13.2523 11.5497 13.444 11.3776C13.8267 11.0572 14.3167 10.8941 14.815 10.9212C15.3133 10.9484 15.7827 11.1638 16.1283 11.5238L18.398 13.375H24.6254C24.1778 13.375 23.7486 13.1972 23.4321 12.8807C23.1157 12.5643 22.9379 12.1351 22.9379 11.6875C22.9379 11.2399 23.1157 10.8107 23.4321 10.4943C23.7486 10.1778 24.1778 10 24.6254 10H31.691C32.2876 10.0001 32.8598 10.2373 33.2817 10.6593L36.4379 13.8149"
                                                        stroke="#F01543"
                                                        strokeWidth="1.3"
                                                        strokeLinecap="round"
                                                        strokeLinejoin="round"
                                            ...
                                            <div className="sherah-progress-card__content">
                                                ...
                                                <div className="sherah-progress-card__button">
                                                    <p className="sherah-progress-card__text sherah-color3"></p>
                                                </div>
                                            </div>
                                        </div>
                                        {/* End Progress Card */}
                                    ...
                                    <div className="col-lg-3 col-md-6 col-12">
                                        ...
                                        <div className="sherah-progress-card sherah-border sherah-default-bg mg-top-30">
z"
                                                        fill="#F01543"
                                                    />
                                                    <path
                                                        d="M11.184 26.1921C10.8682 25.8593 10.3441 25.8406 10.0054 26.15L7.31153 28.7176L6.17508 27.539C5.85934 27.2062 5.33519 27.1875 4.99649 27.4969C4.67044 27.8385 4.67044 28.376 4.99649 28.7176L6.7222 30.4854C6.87157 30.6527 7.08732 30.7452 7.31145 30.738C7.53349 30.7349 7.7453 30.6441 7.90071 30.4854L11.1838 27.3707C11.5093 27.0721 11.5311 26.5662 11.2324 26.2408C11.2171 26.2238 11.2009 26.2077 11.184 26.1921Z"
                                                        fill="#F01543"
                                                    />
                                                    <path
                                                        d="M23.265 28.0039H13.584C13.1191 28.0039 12.7422 28.3808 12.7422 28.8457C12.7422 29.3107 13.1191 29.6876 13.584 29.6876H23.265C23.7299 29.6876 24.1068 29.3107 24.1068 28.8457C24.1068 28.3808 23.7299 28.0039 23.265 28.0039Z"
                                                        fill="#F01543"
                                                    />
                                                </svg>
                                            </div>
                                            <div className="sherah-progress-card__content">
                                                ...
                                                <div className="sherah-progress-card__button">
                                                    <p className="sherah-progress-card__text sherah-color2"></p>
                                                </div>
                                            </div>
                                        </div>
                                        {/* End Progress Card */}
                                    ...
                                    <div className="col-lg-3 col-md-6 col-12">
                                        ...
                                        <div className="sherah-progress-card sherah-border sherah-default-bg mg-top-30">
                                            ...
                                            <div className="sherah-progress-card__content">
                                                ...
                                                <div className="sherah-progress-card__button">
                                                    <p className="sherah-progress-card__text sherah-color1"></p>
                                                </div>
                                            </div>
                                        </div>
                                        {/* End Progress Card */}
                                    ...
                                    <div className="col-lg-3 col-md-6 col-12">
                                        ...
                                        <div className="sherah-progress-card sherah-border sherah-default-bg mg-top-30">
                                            <div className="sherah-progress-card__icon sherah-default-bg sherah-border">
                                                ...
                                                >
                                                    <path
                                                        d="M2.16665 33.2498H23.8332C25.0298 33.2498 25.9998 32.2797 25.9998 31.0831V5.53234C25.9993 5.30845 25.9522 5.0871 25.8617 4.88234C25.8573 4.87097 25.8503 4.86176 25.8449 4.85039C25.766 4.67714 25.6573 4.51909 25.5237 4.38347L22.3669 1.22612C22.2307 1.09092 22.0718 0.980884 21.8973 0.901125C21.8875 0.896792 21.8794 0.890292 21.8691 0.8865C21.6639 0.796242 21.4422 0.749754 21.218 0.750001L2.16665 0.75C0.970042 0.750001 0 1.72004 0 2.91665V31.0831C0 32.2797 0.970042 33.2498 2.16665 33.2498ZM24.1506 4.54164H23.2915C22.6932 4.54164 22.2082 4.05662 22.2082 3.45831V2.59924L24.1506 4.54164ZM1.08333 2.91665C1.08333 2.31835 1.56835 1.83333 2.16665 1.83333H21.1248V3.45831C21.1248 4.65492 22.0949 5.62496 23.2915 5.62496H24.9165V31.0831C24.9165 31.6814 24.4315 32.1664 23.8332 32.1664H2.16665C1.56835 32.1664 1.08333 31.6814 1.08333 31.0831V2.91665Z"
                                                        fill="#F01543"
                                                    />
                                                    <path
                                                        d="M4.87499 13.2068H8.12496C9.02242 13.2068 9.74995 12.4793 9.74995 11.5818V8.55612L11.2162 7.08984C11.4215 6.8773 11.4186 6.53946 11.2096 6.33052C11.0007 6.12159 10.6629 6.11865 10.4503 6.32393L9.41683 7.35688C9.1125 6.94897 8.63388 6.70816 8.12496 6.70688H4.87499C3.97753 6.70688 3.25 7.43441 3.25 8.33187V11.5818C3.25 12.4793 3.97753 13.2068 4.87499 13.2068ZM4.33333 8.33187C4.33333 8.03272 4.57584 7.79021 4.87499 7.79021H8.12496C8.35078 7.79129 8.55192 7.93317 8.62871 8.14554L7.04164 9.73261L6.34127 9.03224C6.12873 8.82696 5.79089 8.8299 5.58196 9.03884C5.37302 9.24777 5.37008 9.58561 5.57536 9.79815L6.65868 10.8815C6.8702 11.0929 7.21307 11.0929 7.42459 10.8815L8.66663 9.63944V11.5818C8.66663 11.881 8.42412 12.1235 8.12496 12.1235H4.87499C4.57584 12.1235 4.33333 11.881 4.33333 11.5818V8.33187Z"
                                                        fill="#F01543"
                                                    />
                                                    <path
                                                        d="M4.87499 20.7929H8.12496C9.02242 20.7929 9.74995 20.0654 9.74995 19.1679V15.918C9.74995 15.0205 9.02242 14.293 8.12496 14.293H4.87499C3.97753 14.293 3.25 15.0205 3.25 15.918V19.1679C3.25 20.0654 3.97753 20.7929 4.87499 20.7929ZM4.33333 15.918C4.33333 15.6188 4.57584 15.3763 4.87499 15.3763H8.12496C8.42412 15.3763 8.66663 15.6188 8.66663 15.918V19.1679C8.66663 19.4671 8.42412 19.7096 8.12496 19.7096H4.87499C4.57584 19.7096 4.33333 19.4671 4.33333 19.1679V15.918Z"
                                                        fill="#F01543"
                                                    />
                                                    <path
                                                        d="M4.87499 28.375H8.12496C9.02242 28.375 9.74995 27.6474 9.74995 26.75V23.5C9.74995 22.6025 9.02242 21.875 8.12496 21.875H4.87499C3.97753 21.875 3.25 22.6025 3.25 23.5V26.75C3.25 27.6474 3.97753 28.375 4.87499 28.375ZM4.33333 23.5C4.33333 23.2008 4.57584 22.9583 4.87499 22.9583H8.12496C8.42412 22.9583 8.66663 23.2008 8.66663 23.5V26.75C8.66663 27.0491 8.42412 27.2916 8.12496 27.2916H4.87499C4.57584 27.2916 4.33333 27.0491 4.33333 26.75V23.5Z"
                                                        fill="#F01543"
                                                    />
                                                    <path
                                                        d="M13.0006 8.87629H22.2089C22.5081 8.87629 22.7506 8.63378 22.7506 8.33463C22.7506 8.03548 22.5081 7.79297 22.2089 7.79297H13.0006C12.7015 7.79297 12.459 8.03548 12.459 8.33463C12.459 8.63378 12.7015 8.87629 13.0006 8.87629Z"
                                                        fill="#F01543"
                                                    />
                                                    <path
                                                        d="M13.0006 11.5833H18.4173C18.7164 11.5833 18.9589 11.3408 18.9589 11.0417C18.9589 10.7425 18.7164 10.5 18.4173 10.5H13.0006C12.7015 10.5 12.459 10.7425 12.459 11.0417C12.459 11.3408 12.7015 11.5833 13.0006 11.5833Z"
                                                        fill="#F01543"
                                                    />
                                                    <path
                                                        d="M13.0006 16.4583H22.2089C22.5081 16.4583 22.7506 16.2158 22.7506 15.9167C22.7506 15.6175 22.5081 15.375 22.2089 15.375H13.0006C12.7015 15.375 12.459 15.6175 12.459 15.9167C12.459 16.2158 12.7015 16.4583 13.0006 16.4583Z"
                                                        fill="#F01543"
                                                    />
                                                    <path
                                                        d="M13.0006 19.1654H18.4173C18.7164 19.1654 18.9589 18.9228 18.9589 18.6237C18.9589 18.3245 18.7164 18.082 18.4173 18.082H13.0006C12.7015 18.082 12.459 18.3245 12.459 18.6237C12.459 18.9228 12.7015 19.1654 13.0006 19.1654Z"
                                                        fill="#F01543"
                                                    />
                                                    <path
                                                        d="M13.0006 24.0404H22.2089C22.5081 24.0404 22.7506 23.7978 22.7506 23.4987C22.7506 23.1995 22.5081 22.957 22.2089 22.957H13.0006C12.7015 22.957 12.459 23.1995 12.459 23.4987C12.459 23.7978 12.7015 24.0404 13.0006 24.0404Z"
                                                        fill="#F01543"
                                                    />
                                                    <path
                                                        d="M13.0006 26.7513H18.4173C18.7164 26.7513 18.9589 26.5088 18.9589 26.2096C18.9589 25.9105 18.7164 25.668 18.4173 25.668H13.0006C12.7015 25.668 12.459 25.9105 12.459 26.2096C12.459 26.5088 12.7015 26.7513 13.0006 26.7513Z"
                                                        fill="#F01543"
                                                    />
                                                </svg>
                                            </div>
                                            <div className="sherah-progress-card__content">
                                                ...
                                                <div className="sherah-progress-card__button">
                                                    <p className="sherah-progress-card__text sherah-color4"></p>
                                                </div>
                                            </div>
                                        </div>
                                        {/* End Progress Card */}

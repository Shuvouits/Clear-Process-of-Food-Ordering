            ...
            <div className="col-lg-6 " data-aos="fade-right">
              <div className="process-img-box">
                <div className="process-img">
                  <img src="https://reservq.minionionbd.com/uploads/website-images/image-2023-10-17-09-10-17-5724.png" alt="thumb" />
                </div>
              </div>
            </div>
            <div className="col-lg-6 col-md-12">
              ...
              <div className="process-item-box">
                ...
                <div className="process-item" data-aos="fade-up" data-aos-delay={200}>
                  ...
                  <div className="process-item-right-img two">
                  </div>
                </div>
                <div className="process-item" data-aos="fade-up" data-aos-delay={300}>
                  ...
                  <div className="text">
                    ...
                    <p>
                      Providing an upscale and elegant ambiance for ..
                    </p>
                  </div>
                  <div className="process-item-right-img three">
                  </div>
                </div>
                <div className="process-item" data-aos="fade-up" data-aos-delay={400}>
                    ...
                    <div className="icon">
                      <span>
                        <svg width={34} height={31} viewBox="0 0 34 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path fillRule="evenodd" clipRule="evenodd" d="M9.08301 8.33203C9.08301 7.64168 9.64265 7.08203 10.333 7.08203L13.6663 7.08203C14.3567 7.08203 14.9163 7.64168 14.9163 8.33203C14.9163 9.02239 14.3567 9.58203 13.6663 9.58203L10.333 9.58203C9.64265 9.58203 9.08301 9.02239 9.08301 8.33203Z" fill="white" />
                          <path fillRule="evenodd" clipRule="evenodd" d="M5.75 15C5.75 14.3096 6.30964 13.75 7 13.75L13.6667 13.75C14.357 13.75 14.9167 14.3096 14.9167 15C14.9167 15.6904 14.357 16.25 13.6667 16.25H7C6.30964 16.25 5.75 15.6904 5.75 15Z" fill="white" />
                        </svg>
                      </span>
                    </div>
                  </div>
                  <div className="text">
                    ...
                    <p>
                      Allowing customers to easily book tables through
                    </p>
                  </div>
                  <div className="process-item-right-img four">
                  </div>
                </div>
              </div>
            </div>

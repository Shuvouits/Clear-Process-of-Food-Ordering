        ...
        <div className="container">
          ...
          <div className="row gap-30 popular-item-box-mt">
            ...
            <div className="col-lg-4 res-popular-mt-30px" data-aos="fade-up">
              <div className="popular-item-box row-card">
                <div className="popular-item-box-img">
                  <img src="https://reservq.minionionbd.com/uploads/custom-images/baked-chicken-wings-and-legs-2024-01-25-10-02-43-3199.jpg" alt="thumb" />
            ...
            <div className="col-lg-4 res-popular-mt-30px" data-aos="fade-up">
              <div className="popular-item-box row-card">
                <div className="popular-item-box-img">
                  <img src="https://reservq.minionionbd.com/uploads/custom-images/bbq-pulled-pork-sandwich-2024-01-25-11-11-44-3353.jpg" alt="thumb" />
                  <div className="popular-item-box-img-overlay">
                  </div>
                </div>
                <div className="popular-inner-box">
                  ...
                  <div className="popular-inner-item-btm">
                    ...
                    <div className="popular-inner-item-btn">
                      <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal3" className="main-btn-five">
                        <span>
                          <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 4H18C20.2091 4 22 5.79086 22 8V13C22 15.2091 20.2091 17 18 17H10C7.79086 17 6 15.2091 6 13V4ZM6 4C6 2.89543 5.10457 2 4 2H2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            </path>
            ...
            <div className="col-lg-4 res-popular-mt-30px" data-aos="fade-up">
              <div className="popular-item-box row-card">
                <div className="popular-item-box-img">
                  <img src="https://reservq.minionionbd.com/uploads/custom-images/pork-chop-with-apple-chutney-2024-01-25-10-49-09-4461.jpg" alt="thumb" />
                  <div className="popular-item-box-img-overlay">
                  </div>
                </div>
                <div className="popular-inner-box">
                  ...
                  <div className="popular-inner-item-btm">
                    ...
                    <div className="popular-inner-item-btn">
                      <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal4" className="main-btn-five">
                        <span>
                          <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 4H18C20.2091 4 22 5.79086 22 8V13C22 15.2091 20.2091 17 18 17H10C7.79086 17 6 15.2091 6 13V4ZM6 4C6 2.89543 5.10457 2 4 2H2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            </path>
            ...
            <div className="col-lg-4 res-popular-mt-30px" data-aos="fade-up">
              <div className="popular-item-box row-card">
                <div className="popular-item-box-img">
                  <img src="https://reservq.minionionbd.com/uploads/custom-images/eggplant-parmesan-linguine-2024-01-25-10-51-58-9002.jpg" alt="thumb" />
                  <div className="popular-item-box-img-overlay">
                  </div>
                </div>
                <div className="popular-inner-box">
                  ...
                  <div className="popular-inner-item-btm">
                    ...
                    <div className="popular-inner-item-btn">
                      <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal5" className="main-btn-five">
                        <span>
                          <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 4H18C20.2091 4 22 5.79086 22 8V13C22 15.2091 20.2091 17 18 17H10C7.79086 17 6 15.2091 6 13V4ZM6 4C6 2.89543 5.10457 2 4 2H2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            </path>
            ...
            <div className="col-lg-4 res-popular-mt-30px" data-aos="fade-up">
              <div className="popular-item-box row-card">
                <div className="popular-item-box-img">
                  <img src="https://reservq.minionionbd.com/uploads/custom-images/fish-tacos-with-chipotle-crema-2024-01-25-10-56-10-8397.jpg" alt="thumb" />
                  <div className="popular-item-box-img-overlay">
                  </div>
                </div>
                <div className="popular-inner-box">
                  ...
                  <div className="popular-inner-item-btm">
                    ...
                    <div className="popular-inner-item-btn">
                      <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal6" className="main-btn-five">
                        <span>
                          <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 4H18C20.2091 4 22 5.79086 22 8V13C22 15.2091 20.2091 17 18 17H10C7.79086 17 6 15.2091 6 13V4ZM6 4C6 2.89543 5.10457 2 4 2H2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            </path>
            ...
            <div className="col-lg-4 res-popular-mt-30px" data-aos="fade-up">
              <div className="popular-item-box row-card">
                <div className="popular-item-box-img">
                  <img src="https://reservq.minionionbd.com/uploads/custom-images/quinoa-stuffed-bell-pepper-2024-01-25-11-07-09-6249.jpg" alt="thumb" />
                  <div className="popular-item-box-img-overlay">
                  </div>
                </div>
                <div className="popular-inner-box">
                  ...
                  <div className="popular-inner-item-btm">
                    ...
                    <div className="popular-inner-item-btn">
                      <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal7" className="main-btn-five">
                        <span>
                          <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 4H18C20.2091 4 22 5.79086 22 8V13C22 15.2091 20.2091 17 18 17H10C7.79086 17 6 15.2091 6 13V4ZM6 4C6 2.89543 5.10457 2 4 2H2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            </path>
            ...
            <div className="col-lg-4 res-popular-mt-30px" data-aos="fade-up">
              <div className="popular-item-box row-card">
                <div className="popular-item-box-img">
                  <img src="https://reservq.minionionbd.com/uploads/custom-images/beef-nachos-2024-01-31-11-14-31-2417.png" alt="thumb" />
                  <div className="popular-item-box-img-overlay">
                  </div>
                </div>
                <div className="popular-inner-box">
                  ...
                  <div className="popular-inner-item-btm">
                    ...
                    <div className="popular-inner-item-btn">
                      <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal12" className="main-btn-five">
                        <span>
                          <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 4H18C20.2091 4 22 5.79086 22 8V13C22 15.2091 20.2091 17 18 17H10C7.79086 17 6 15.2091 6 13V4ZM6 4C6 2.89543 5.10457 2 4 2H2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            </path>
            ...
            <div className="col-lg-4 res-popular-mt-30px" data-aos="fade-up">
              <div className="popular-item-box row-card">
                <div className="popular-item-box-img">
                  <img src="https://reservq.minionionbd.com/uploads/custom-images/fish-tacos-2024-01-31-11-19-33-7126.png" alt="thumb" />
                  <div className="popular-item-box-img-overlay">
                  </div>
                </div>
                <div className="popular-inner-box">
                  ...
                  <div className="popular-inner-item-btm">
                    ...
                    <div className="popular-inner-item-btn">
                      <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal13" className="main-btn-five">
                        <span>
                          <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 4H18C20.2091 4 22 5.79086 22 8V13C22 15.2091 20.2091 17 18 17H10C7.79086 17 6 15.2091 6 13V4ZM6 4C6 2.89543 5.10457 2 4 2H2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            </path>
